...
export function ResumeDashboardPage() {
    ...
    const [resumeToDelete, setResumeToDelete] =
        useState<ResumeListItemResponse | null>(null);
    ...
    return (
        ...
        >
                ...
                {dashboard.resumeSearch.isPending ? (
                    ...
                    <>
                        <ResumeDashboardList
                            ...
                            onEdit={(resumeId) =>
                                dashboard.selectResume(resumeId, 'builder')
                            }
                            onView={(resumeId) =>
                                dashboard.selectResume(resumeId, 'preview')
                            }
                        />
                        <DashboardPagination
            ...
            <DeleteResumeDialog
                ...
                onConfirm={() => {
                    if (resumeToDelete) {
                        void dashboard.deleteResume
                            .mutateAsync(resumeToDelete.id)
                            .then(() => {
