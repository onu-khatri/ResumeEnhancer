...
export function ResumePreviewPage() {
  ...
  if (resumeId === null) {
    return (
      ...
      >
        <EmptyState
          action={<Button onClick={() => navigate('/app/resume/dashboard')}>Open dashboard</Button>}
  ...
  if (resumeQuery.isError) {
    return (
      <ResumeShell
        actions={<Button onClick={() => navigate('/app/resume/builder')} variant="outline">Edit builder</Button>}
  ...
  if (!resumeQuery.data) {
    return (
      ...
      >
        <EmptyState
          action={<Button onClick={() => navigate('/app/resume/builder')}>Go to builder</Button>}
  ...
  return (
    <ResumeShell
      actions={<Button onClick={() => navigate('/app/resume/builder')} variant="outline">Edit resume</Button>}
    ...
    >
      <div className="space-y-6">
        ...
        <Card className="overflow-hidden rounded-[2rem] border-white/60 bg-white/90 p-0 dark:border-white/10 dark:bg-slate-950/80">
          <PreviewHero contactDetails={contactDetails} resume={resume} />
