        ...
        <ResumeShell
            actions={
                <Button onClick={controller.saveResume}>
                    {controller.submitResume.isPending
                        ? 'Saving...'
                        : 'Save and preview'}
                </Button>
            }
        ...
        >
            <div className="grid gap-6 xl:grid-cols-[minmax(0,1fr)_320px]">
                <div className="space-y-6">
                    ...
                    <SocialLinksSection
                        array={controller.arrays.socialLinks}
                        form={controller.form}
                    />
                    <SkillsSection
                        array={controller.arrays.skills}
                        form={controller.form}
                    />
                    <EducationSection
                        array={controller.arrays.education}
                        form={controller.form}
                    />
                    ...
                    />
                    <ProjectsSection
                        array={controller.arrays.projects}
                        form={controller.form}
                    />
