...
export interface ResumeBuilderFieldArrays {
    ...
    >;
    workExperiences: UseFieldArrayReturn<ResumeFormValues, 'workExperiences'>;
}
...
export type CertificationArray = UseFieldArrayReturn<
    ...
    'certifications'
>;
export type EducationArray = UseFieldArrayReturn<ResumeFormValues, 'education'>;
