                        ...
                        <InputField
                            error={
                                form.formState.errors.personalInformation
                                    ?.awards?.[index]?.awardName?.message
                            }
                            label="Award"
                            {...form.register(
                                `personalInformation.awards.${index}.awardName`,
                            )}
                        />
                        <InputField
                            error={
                ...
                {(index) => (
                    <>
                        <InputField
                            error={
                                form.formState.errors.personalInformation
                                    ?.languages?.[index]?.languageName?.message
                            }
                            label="Language"
                            {...form.register(
                                `personalInformation.languages.${index}.languageName`,
                            )}
                        />
                        <InputField
                            error={
            ...
            <CompactSection array={hobbies} onAdd={createHobby} title="Hobbies">
                {(index) => (
                    <InputField
                        error={
                            form.formState.errors.personalInformation
                                ?.hobbies?.[index]?.hobbyName?.message
                        }
                        label="Hobby"
                        {...form.register(
                            `personalInformation.hobbies.${index}.hobbyName`,
                        )}
                    />
                )}
            </CompactSection>
