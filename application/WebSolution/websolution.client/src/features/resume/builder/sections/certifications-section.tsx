    ...
    >
      {(_field, index) => (
        <div className="grid gap-4 md:grid-cols-2">
          <InputField
            error={form.formState.errors.certifications?.[index]?.certificationName?.message}
            label="Certification name"
            placeholder="AWS Certified Developer"
            {...form.register(`certifications.${index}.certificationName`)}
          />
          <InputField
            error={form.formState.errors.certifications?.[index]?.issuingOrganization?.message}
            label="Issuer"
            placeholder="Amazon Web Services"
            {...form.register(`certifications.${index}.issuingOrganization`)}
          />
          <InputField
          ...
          />
          <InputField
            error={form.formState.errors.certifications?.[index]?.expirationDate?.message}
          ...
          <TextareaField
            ...
            error={form.formState.errors.certifications?.[index]?.description?.message}
            label="Details"
