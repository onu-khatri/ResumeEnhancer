...
function CompletionCard({
    ...
    return (
        <Card className="rounded-[2rem]">
            <p className="text-sm font-semibold tracking-[0.24em] text-slate-600 uppercase dark:text-slate-300">
                Completion
            </p>
    ...
    return (
        <Card className="rounded-[2rem]">
            ...
            <p className="mt-3 text-sm leading-6 text-slate-700 dark:text-slate-300">
                Drafts autosave locally while you work, so accidental refreshes
