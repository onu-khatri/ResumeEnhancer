            ...
            <div className="mx-auto flex max-w-7xl flex-col gap-6">
                <Card className="rounded-[2rem] border-slate-300/70 bg-white/92 backdrop-blur-sm dark:border-slate-700 dark:bg-slate-950/80">
                    <div className="flex flex-col gap-5 lg:flex-row lg:items-start lg:justify-between">
                        <div>
                            <p className="text-xs font-semibold tracking-[0.3em] text-teal-800 uppercase dark:text-teal-300">
                                {eyebrow}
                            </p>
                            <h1 className="mt-3 font-serif text-3xl font-semibold tracking-tight text-slate-950 sm:text-4xl dark:text-white">
                                {title}
                            </h1>
                        ...
                        <div className="flex flex-col gap-3 sm:flex-row sm:items-center">
                            <Card className="rounded-2xl border-slate-300/70 bg-slate-50/90 px-4 py-3 shadow-none dark:border-slate-800 dark:bg-slate-900/80">
                                <p className="text-xs tracking-[0.24em] text-slate-600 uppercase">
                                    Session
                                </p>
                ...
                <div className="fixed inset-0 flex items-center justify-center p-4">
                    <DialogPanel className="w-full max-w-md rounded-[2rem] border border-white/10 bg-white p-6 shadow-2xl dark:bg-slate-900">
                        ...
                        <p className="mt-3 text-sm leading-6 text-slate-600 dark:text-slate-300">
                            Your draft stays on this device. The local session
                            will be cleared and protected routes will require
                            sign-in again.
                        </p>
