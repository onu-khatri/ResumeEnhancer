...
export function createResumeService(apiClient: ReturnType<typeof createApiClient>) {
  return {
    ...
    getResume: (resumeId: number) =>
      apiClient.get<ResumeDetailResponse>(`${resumeApiBasePath}/${resumeId}`),
...
export function mapResumeResponseToForm(
  ...
  return {
    ...
    personalInformation: {
      ...
      languages: (personalInformation?.languages ?? []).map(mapLanguageFromApi),
  ...
  return {
    address: personalInformation.removeAddress
      ...
      : {
          ...
          country: toNullableString(personalInformation.address.country),
          id:
          ...
          postalCode: toNullableString(personalInformation.address.postalCode),
    ...
    socialMediaLinks: mapApiItem(personalInformation.socialMediaLinks, (item) => ({
    ...
    useSameLanguagesAsProfile: personalInformation.useSameLanguagesAsProfile,
    useSamePhoneNumberAsProfile: personalInformation.useSamePhoneNumberAsProfile,
    useSameSocialMediaLinksAsProfile:
