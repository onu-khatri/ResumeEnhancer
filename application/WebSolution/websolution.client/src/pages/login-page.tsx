            ...
            <div className="mx-auto flex min-h-[calc(100vh-4rem)] max-w-6xl items-center">
                <div className="grid w-full gap-8 lg:grid-cols-[1.15fr_0.85fr]">
                    <section className="rounded-[2rem] border border-slate-300/70 bg-white/92 p-8 shadow-[0_28px_100px_rgba(15,23,42,0.12)] backdrop-blur-sm dark:border-slate-700 dark:bg-slate-900/78">
                        <p className="text-sm font-semibold tracking-[0.3em] text-teal-800 uppercase dark:text-teal-300">
                            Resume Enhancer
                        </p>
                        <h1 className="mt-6 max-w-xl font-serif text-4xl font-semibold tracking-tight text-slate-950 sm:text-5xl dark:text-white">
                            Build a resume workspace that feels calm, credible,
                            and ready to send.
                        </h1>
                        <p className="mt-5 max-w-2xl text-base leading-8 text-slate-700 dark:text-slate-300">
                            This frontend is wired for protected routes, session
                            refresh, and cookie-based API usage. For now, we are
                            using a local workspace session so the resume flow
                            can move ahead before backend auth is connected.
                        </p>
                        ...
                        <div className="mt-8 grid gap-4 sm:grid-cols-3">
                            {[
                                ...
                                <Card
                                    key={item}
                                    className="border-slate-300/70 bg-slate-50/85"
                                >
                    ...
                    <Card className="rounded-[2rem] border-slate-300/70 bg-white p-8 shadow-[0_30px_110px_rgba(15,23,42,0.14)] dark:border-slate-700 dark:bg-slate-900">
                        ...
                        <p className="mt-3 text-sm leading-7 text-slate-700 dark:text-slate-300">
                            Use the temporary local session now. When the real
                            authentication endpoints are ready, the provider and
                            API client already have the seams to swap in secure
                            HTTP-only cookie flows.
                        </p>
                        ...
                        <p className="mt-4 text-xs leading-5 text-slate-600 dark:text-slate-400">
                            Session state is persisted locally and mirrored with
                            a lightweight cookie marker so the API layer is
                            already configured for `credentials: include`.
                        </p>
                    </Card>
                </div>
            </div>
