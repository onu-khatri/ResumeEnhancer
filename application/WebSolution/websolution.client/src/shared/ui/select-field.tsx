    ...
    <label className="grid gap-2">
      ...
      <Listbox value={selectedOption.value} onChange={onChange}>
        <div className="relative">
          <ListboxButton
            className={cn(
              'flex h-12 w-full items-center justify-between rounded-2xl border border-slate-300 bg-white px-4 text-left text-sm text-slate-950 shadow-sm focus:border-teal-700 focus:outline-none focus:ring-4 focus:ring-teal-700/12 dark:border-slate-700 dark:bg-slate-950 dark:text-white',
