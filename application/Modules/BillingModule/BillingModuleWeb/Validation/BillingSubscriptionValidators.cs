...
public sealed class CreateBillingSubscriptionRequestValidator
    : AbstractValidator<CreateBillingSubscriptionRequest>
{
...
public sealed class UpdateBillingSubscriptionRequestValidator
    : AbstractValidator<UpdateBillingSubscriptionRequest>
{
