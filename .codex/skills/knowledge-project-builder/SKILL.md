---
name: knowledge-project-builder
description: Build durable, evidence-grounded knowledge artifacts for ResumeEnhancer through an approval-driven workflow with sequential quality gates A–H, including a mandatory workflow-user-interview gate. Use when an agent needs reusable knowledge about architecture, feature flows, conventions, responsibilities, or requirement-to-implementation traceability.
---
