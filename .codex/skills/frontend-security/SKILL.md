...
For multi-skill work, follow [frontend workflow routing](../frontend-guidelines/references/frontend-workflow-routing.md). This is a bounded security pass: return findings or required constraints to the primary owner and do not delegate implementation.
