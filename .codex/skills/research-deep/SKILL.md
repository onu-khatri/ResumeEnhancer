...
- the request is only to author or revise a story pack; use `product-user-story`
- the request is to coordinate approved story delivery; use `delivery-user-story-kickoff`

## Research workflow

1. Frame the decision: state the question, affected audience or system, decision owner when known, scope boundary, and what evidence could change the outcome. Use `$workflow-user-interview` if this cannot be established from the request and repository.
...
- Research that becomes a user-story pack: `$product-user-story`.
- Approved story sequencing and execution: `$delivery-user-story-kickoff`.
- Architecture decision record: `$architecture-adr`.
- Durable repository knowledge: `$knowledge-project-builder`.
