...
For multi-skill work, follow [frontend workflow routing](../frontend-guidelines/references/frontend-workflow-routing.md). Return prioritized findings or narrowly scoped safe fixes to the primary owner; do not invoke implementation or design skills recursively.
