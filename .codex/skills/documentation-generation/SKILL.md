...
Use this skill to produce documentation that reflects the real codebase, not generic templates. It pairs with `knowledge-project-builder` for reusable knowledge and `architecture-adr` for decisions.
...
- the deliverable is durable knowledge for agents (use `knowledge-project-builder`)
- the deliverable is a formal decision record (use `architecture-adr`)
