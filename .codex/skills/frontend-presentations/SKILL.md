...
For multi-skill work, follow [frontend workflow routing](../frontend-guidelines/references/frontend-workflow-routing.md). This is a terminal communication step and does not trigger design, implementation, or review work.
