...
Use this skill to make ResumeEnhancer reviews systematic rather than intuitive. Pair with `quality-production-code-review` for the review workflow and severity model.
...
- you need architecture-only advice without a diff (use `architecture-review`)
