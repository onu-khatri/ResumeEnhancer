...
Use this skill to write public-facing ResumeEnhancer content that ranks and converts, grounded in the actual product features and target audience.

## Use this skill when

- writing or refreshing the public landing page or marketing site
- composing help articles, blog posts, or release notes
- optimizing public resume discovery metadata (see US-2.1)
- creating content that must compete for search intent

## Do not use this skill when

- the content is internal-only documentation or ADRs
- the primary goal is technical accuracy for developers (use `documentation-generation`)
...
## ResumeEnhancer domain

- Audience: job seekers, career changers, resume professionals.
- Core keywords: resume builder, resume enhancer, AI resume, ATS-friendly resume, cover letter generator.
- Feature pages to optimize: public resume templates, theme gallery, pricing, help/FAQ.
- Public resume discovery (US-2.1) pages should use schema markup for rich snippets.
