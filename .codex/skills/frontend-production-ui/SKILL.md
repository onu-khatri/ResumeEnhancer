...
For multi-skill work, follow [frontend workflow routing](../frontend-guidelines/references/frontend-workflow-routing.md). Use this as the sole primary implementation lane only for an explicitly UI-dominant request; otherwise provide a design/implementation handoff and do not run alongside `$frontend-development`.
