...
This skill is a handoff workflow, not a story-authoring workflow. Use `product-user-story` to create or revise the story pack, and only run this skill after the story is approved and ready for issue creation.
